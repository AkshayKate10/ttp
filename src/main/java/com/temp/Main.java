...
public class Main {
    ...
    public static int commasPresent(String input) {
    ...
    public static int missingLastNumber(String input) {
    ...
    public static void NegativeNumber(String input) {
        String[] data = input.split(",");
...
//         int fromNegativeNumber = missingLastNumber("45,85");
//        System.out.println(fromNegativeNumber);
//    }
